...
public class ModelTHFairy extends ModelBase
{
  //fields
    ModelRenderer head;
    ModelRenderer body;
  ...
  public ModelTHFairy()
  {
    ...
    textureHeight = 64;
  	...
  	head.addChild(this.flowerCenter);
  ...
  public void setRotationAngles(float movement, float far, float tick, float yaw, float pitch, float size, Entity entity)
  {
    ...
    if(thFairy.getHealth() > 0F)
    {
    	...
    	if(thFairy.getFlyingHeight() > 0)
    	{
	        this.rightWing.rotateAngleY = MathHelper.cos(tick * 1.3F) * (float)Math.PI * 0.25F;
	        this.leftWing.rotateAngleY = -this.rightWing.rotateAngleY;
	    	this.rightWing2.rotateAngleY = MathHelper.cos(tick * 1.3F) * (float)Math.PI * 0.25F;
	        this.leftWing2.rotateAngleY = -this.rightWing2.rotateAngleY;
    	}
    	else
    	{
	        this.rightWing.rotateAngleY = MathHelper.cos(tick * 0.5F) * (float)Math.PI * 0.1F + (float)Math.PI * 0.15F;
	        this.leftWing.rotateAngleY = -this.rightWing.rotateAngleY;
	    	this.rightWing2.rotateAngleY = MathHelper.cos(tick * 0.5F) * (float)Math.PI * 0.1F + (float)Math.PI * 0.15F;
	        this.leftWing2.rotateAngleY = -this.rightWing2.rotateAngleY;
    	}
    }
    else
    {
        ...
        this.leftWing.rotateAngleY = -this.rightWing.rotateAngleY;
    	this.rightWing2.rotateAngleY = -25F;
        this.leftWing2.rotateAngleY = -this.rightWing2.rotateAngleY;
